...
def noise(data ,n , col1 ,col2):
    r , c = data.shape 
    p = n * r
    p = int (p)
    samp = random.sample(range(r), p)
    for i in samp:
        #print("data[i ,clo1 mmmmmmm",i , data[i,col1])
        #print("data[i ,clo2mmmmmm",i , data[i,col2])
        data[i,col1],data[i,col2]=data[i,col2],data[i,col1]
        #print("data[i ,clo1",i , data[i,col1])
        #print("data[i ,clo2",i , data[i,col2])
    
    return data

def noise_num(data,n,col1,col2):
    mu, sigma = 0, 0.1 
...
def test_run():
    ...
    set3 = array[2000:4000, :]
 
    col1 = 1
    col2 = 2
   
    #set1 = noise(set1 , 0.1 , 2 ,1)
    
    #set1 = noise(set1 , 0.1 , 3 ,4)
    #set1 = noise(set1 , 0.1 , 6 ,7)
    #set1 = noise(set1 , 0.1 , 8 ,10)
    #set2 = noise(set2 , 0.4 ,col1 ,col2)
    #set3 = noise(set3,0.4,col1,col2)
    #noise_num(array , 0.2, col1 ,col2)
...
#        train_set =  noise(train_set, 0.1 , 2 ,1)
      
        #train_set = global_workspace(training_set)
